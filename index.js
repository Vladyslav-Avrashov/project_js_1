import{a as d,i as j,S as h,N as v,K as w}from"./assets/vendor-jn0Pskas.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=s(t);fetch(t.href,i)}})();const g=[{title:"Wallet webservice",url1:"/img/projectimages/manage-finances@1x.jpg",url2:"/img/projectimages/manage-finances@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Green harvest webservice",url1:"/img/projectimages/organic-vegetables@1x.jpg",url2:"/img/projectimages/organic-vegetables@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"English Exellence webservice",url1:"/img/projectimages/discover@1x.jpg",url2:"/img/projectimages/discover@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Power pulse webservice",url1:"/img/projectimages/transforming@1x.jpg",url2:"/img/projectimages/transforming@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Mimino website",url1:"/img/projectimages/mimino@@1x.jpg",url2:"/img/projectimages/mimino@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Vyshyvanka vibes Landing Page",url1:"/img/projectimages/reviving-traditions@1x.jpg",url2:"/img/projectimages/reviving-traditions@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Chego jewelry website",url1:"/img/projectimages/a-brand@1x.jpg",url2:"/img/projectimages/a-brand@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Energy flow webservice",url1:"/img/projectimages/bodyshape@1x.jpg",url2:"/img/projectimages/bodyshape@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"fruitbox online store",url1:"/img/projectimages/fresh-harvest@1x.jpg",url2:"/img/projectimages/fresh-harvest@2x.jpg",technologies:"React, JavaScript, Node JS, Git"},{title:"Starlight studio landing page",url1:"/img/projectimages/turn-on@1x.jpg",url2:"/img/projectimages/turn-pn@2x.jpg",technologies:"React, JavaScript, Node JS, Git"}],u=e=>e.map(r=>{const{title:s,url1:a,url2:t,technologies:i}=r;return`
